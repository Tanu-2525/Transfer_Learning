...
def training(data_dir="flowers",save_dir="model_checkpoint.pth",arch="inception_v3",gpu=True,learning_rate=0.02,hidden_units=550,epochs=8):
    #Data Directory
...
if __name__ == "__main__":
    ...
    training(args.data_dir, args.save_dir,args.arch,args.gpu, args.learning_rate, args.hidden_units, args.epochs)